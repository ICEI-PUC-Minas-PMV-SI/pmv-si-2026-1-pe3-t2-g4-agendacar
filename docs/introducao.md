...
## Objetivo Geral
Este trabalho tem o objetivo de desenvolver um software para solucionar os problemas de praticidade, agilidade e organização no agendamento de serviços automotivos. Por meio da automatização dos processos de agendamento, gestão de demandas e comunicação com o cliente, a plataforma permitirá que profissionais do setor se concentrem em prestar um serviço de qualidade, enquanto os clientes terão mais autonomia, transparência e agilidade no acesso aos serviços de que necessitam.

## Objetivos Específicos
- Implementar um sistema de agendamento online que permita ao cliente marcar horários de forma rápida e autônoma, visualizando a disponibilidade do profissional em tempo real, sem necessidade de atendimento presencial.
- Desenvolver um painel gerencial com visualização Kanban para que a equipe da oficina gerencie o fluxo de atendimentos, evitando conflitos de horário, atrasos e desorganização nas demandas do dia.
- Disponibilizar ao cliente informações claras e atualizadas sobre preços, tempo estimado de serviço e disponibilidade, promovendo transparência em todo o processo de atendimento.
- Criar um marketplace que permita ao cliente localizar oficinas por proximidade ou localidade, consultar serviços disponíveis e reduzir o tempo gasto com deslocamentos desnecessários.
- Implementar um mecanismo de busca por disponibilidade imediata, voltado a situações de urgência, que indique ao cliente qual oficina pode realizar o atendimento mais rapidamente.
