...
6.	O sistema sinaliza que o agendamento está pendente de aceite pela outra parte envolvida.
  a)	Caso o usuário seja do tipo cliente, o fluxo segue para a etapa 1 do caso de uso CSU-10, onde o prestador decide sobre a solicitação de agendamento do cliente.
  b)	Caso o usuário seja do tipo prestador de serviços, o fluxo segue para a etapa 5 do caso de uso CSU-10, onde o sistema encaminha ao cliente, por e-mail, a sugestão de data/horário feita pelo prestador.
